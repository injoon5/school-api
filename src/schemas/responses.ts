...
export const SchoolInfoRowSchema = t.Object(
  {
    ...
    ATPT_OFCDC_SC_NM: neisString("Office of education name", "부산광역시교육청"),
    ...
    LCTN_SC_NM: neisString("Location", "부산광역시"),
    JU_ORG_NM: neisString("Administrative organization", "부산광역시교육청"),
    FOND_SC_NM: neisString("Establishment type", "공립"),
    ORG_RDNZC: neisString("Postal code", "47541"),
    ORG_RDNMA: neisString("Road address", "부산광역시 연제구 과정로 123"),
    ORG_RDNDA: neisString("Address detail", "(연산동)"),
    ORG_TELNO: neisString("Phone", "051-000-0000"),
    HMPG_ADRES: neisString("Website", "https://example.school.kr"),
    COEDU_SC_NM: neisString("Coeducation", "남여공학"),
    ORG_FAXNO: neisString("Fax", "051-000-0001"),
    ...
    [
      {
        ...
        FOND_SC_NM: "공립",
        ORG_RDNZC: "47541",
        ORG_RDNMA: "부산광역시 연제구 과정로 123",
        ORG_RDNDA: "(연산동)",
        ORG_TELNO: "051-000-0000",
        HMPG_ADRES: "https://example.school.kr",
        COEDU_SC_NM: "남여공학",
        ORG_FAXNO: "051-000-0001",
        HS_SC_NM: "일반고",
