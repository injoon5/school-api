...
export const SchoolInfoRowSchema = t.Object(
  {
    ...
    ENG_SCHUL_NM: neisOptionalString("English school name", "Yangchung High School"),
    ...
    FOND_SC_NM: neisOptionalString("Establishment type", "사립"),
    ORG_RDNZC: neisOptionalString("Postal code", "07985"),
    ORG_RDNMA: neisOptionalString("Road address", "서울특별시 양천구 안양천로 1039"),
    ORG_RDNDA: neisOptionalString("Address detail", "(목동)"),
    ORG_TELNO: neisString("Phone", "02-2649-7072"),
    HMPG_ADRES: neisOptionalString("Website", "https://yangchung.sen.hs.kr"),
    COEDU_SC_NM: neisString("Coeducation", "남"),
    ORG_FAXNO: neisOptionalString("Fax", "02-2649-7079"),
